...
<!--        <el-form-item prop="version" label-width="100px">-->
<!--          <el-input v-model="product.version" type="hidden" style="width: 80%"></el-input>-->
<!--        </el-form-item>-->
      </el-form>
...
import { apiProductCreate, apiProductUpdate, apiProductDelete, apiProductRemove, apiProductSearch } from '@/api/product'
// 导入全局存储
...
export default {
  ...
  methods: {
    ...
    getProductList() {
      ...
      apiProductSearch().then(response => {
        // cons ole.log（）是调试打印，可以在chrome开发者工具中查看
    ...
    dialogProductUpdate(row) {
      ...
      this.product.version = row.version
      this.product.operator = this.op_user
