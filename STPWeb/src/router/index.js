...
export const constantRoutes = [
  ...
  },
  {
    ...
    component: Layout,
    redirect: '/testTool',
    meta: { title: '测试工具', icon: 'test_tools' },
    children: [
      {
        path: 'testPage',
        name: 'testPage',
        component: () => import('@/views/new-page/newPage'),
        meta: { title: '测试页面' ,icon: 'testpage'}
      }, {
        path: 'updateEs',
        name: 'updateEs',
        component: () => import('@/views/operateEs/index'),
        meta: { title: '更新es' , icon: 'update_es'}
      }
    ]
  },
  {
    ...
    component: Layout,
    redirect: '/demo',
    meta: { title: '演示Demo' ,icon: 'eye'},
    children: [{
      path: 'upload',
      name: 'Upload',
      component: () => import('@/views/demo/uploadDemo'),
      meta: { title: '文件上传Demo', icon: 'upload'}
    },
    {
      path: 'chart',
      name: 'chart',
      component: () => import('@/views/demo/echartsDemo'),
      meta: { title: 'Echarts Demo', icon: '数据分析' }
    }
    ]
  },
